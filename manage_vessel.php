...
$ss_setup_vessel_type = mysqli_query($db,"SELECT * FROM ship.ss_setup_vessel_type order by vessel_type_id desc");
...
<body>
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title"> Search Vessel for Charter</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-row ">
                                                ...
                                                <select name="v_vessel_type[]" class="js-example-basic-multiple"
                                                    multiple="multiple" required id="v_vessel_type">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="v_charter_type[]" class="js-example-basic-multiple"
                                                multiple="multiple" required id="v_charter_types">
                                                <?php foreach($ss_setup_charter_type as $key => $value){ ?>
                                                <option groupid="<?= $value['charter_type_name']; ?>"
                                                    value="<?= $value['charter_type_id'];?>">
    ...
    $(document).ready(function() {
        ...
        $("#insert").on('click', (function(e) {
            ...
            var data_lead = "v_vessel_type=" + $('#v_vessel_type').val() +
                "&dwt_from=" + $('#dwt_from').val() +
                "&dwt_to=" + $('#dwt_to').val() +
                "&v_charter_type=" + $('#v_charter_types').val() +
            ...
            var table1 = $('#search_data').DataTable({
                "ajax": "data/get_vessel_data.php?" + data_lead + "",
                "columns": [
            ...
            function format1(d) {
                ...
                return '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">' +
                    '<tr>' +
                    '<td>' +
                    '<div class="expend_label">Built Year: </div>' +
                    '<div class="expend_text">' + d.built_year + '</div>' +

                    '<div class="expend_label">DWT: </div>' +
                    '<div class="expend_text">  ' + d.dwt + '</div>' +
                    '<div class="expend_label">DWCC: </div>' +
                    '<div class="expend_text">  ' + d.dwcc + '</div>' +
                    '</td>' +

                    '<td>' +
                    '<div class="expend_label">IMO Number: </div>' +
                    '<div class="expend_text">' + d.imo_number + '</div>' +

                    '<div class="expend_label">Call Sign: </div>' +
                    '<div class="expend_text">  ' + d.call_sign + '</div>' +
                    '<div class="expend_label">Speed Ballast: </div>' +
                    '<div class="expend_text">  ' + d.speed_ballast + '</div>' +
                    '</td>' +

                    '<td>' +
                    '<div class="expend_label">Speed Laden: </div>' +
                    '<div class="expend_text">  ' + d.speed_laden + '</div>' +

                    '<div class="expend_label">Gross Tonnage: </div>' +
                    '<div class="expend_text">' + d.gross_tonnage + '</div>' +
                    '<div class="expend_label">Net Tonnage: </div>' +
                    '<div class="expend_text">' + d.net_tonnage + '</div>' +
                    '</td>' +

                    '<td>' +
                    '<div class="expend_label">LOA Max: </div>' +
                    '<div class="expend_text">' + d.loa_max + '</div>' +

                    '<div class="expend_label">Beam Max: </div>' +
                    '<div class="expend_text">' + d.beam_max + '</div>' +
                    ...
                    '<div class="expend_label">Grain Capacity: </div>' +
                    '<div class="expend_text">' + d.grain_capacity + '</div>' +

                    '<div class="expend_label">Bale Capacity: </div>' +
                    '<div class="expend_text">' + d.bale_capacity + '</div>' +
                    '</td>' +

                    '<td>' +
                    '<div class="expend_label">Container Capacity 20FT: </div>' +
                    '<div class="expend_text">' + d.container_capacity_20ft + '</div>' +

                    '<div class="expend_label">Container Capacity 40FT: </div>' +
                    '<div class="expend_text">' + d.container_capacity_40ft + '</div>' +
                    '<div class="expend_label">Container Capacity 40CH: </div>' +
                    '<div class="expend_text">' + d.container_capacity_40ch + '</div>' +
                    '</td>' +

                    '<td>' +
                    '<div class="expend_label">IFO Consumption Empty: </div>' +
                    '<div class="expend_text">' + d.ifo_consumption_empty + '</div>' +

                    '<div class="expend_label">IFO Consumption Laden: </div>' +
                    '<div class="expend_text">' + d.ifo_consumption_laden + '</div>' +
                    '<div class="expend_label">IFO Consumption Port: </div>' +
                    '<div class="expend_text">' + d.ifo_consumption_port + '</div>' +
                    '</td>' +

                    '<td>' +
                    '<div class="expend_label">MGO Consumption Empty: </div>' +
                    '<div class="expend_text">' + d.mgo_consumption_empty + '</div>' +

                    '<div class="expend_label">MGO Consumption Laden: </div>' +
                    '<div class="expend_text">' + d.mgo_consumption_laden + '</div>' +
                    '<div class="expend_label">MGO Consumption Port: </div>' +
                    '<div class="expend_text">' + d.mgo_consumption_port + '</div>' +
                    '</td>' +

                    '<td>' +
                    '<div class="expend_label">Lane Meters: </div>' +
                    '<div class="expend_text">' + d.lane_meters + '</div>' +
                    '<div class="expend_label">P I Club: </div>' +
                    '<div class="expend_text">' + d.p_i_club + '</div>' +
                    '<div class="expend_label">Classed By: </div>' +
                    '<div class="expend_text">' + d.classed_by + '</div>' +
                    ...
                    '"><a href="broker_chat.php?id=' + d.created_by + '&module_id=' + d.vessel_id +
                    '&module_type=Vessel" class="btn  text-light my-2 font-italic font-bold" style="letter-spacing:0;background-color: #00997d;"> Message Directly </a></div>' +
            ...
            $('#search_data tbody').on('click', 'td.dt-control', function() {
                ...
                var vessel_id = id;
                console.log("Veseel id " + vessel_id)
            ...
            var table = $('#after_search').DataTable({
                ...
                'serverSide': true,
                'serverMethod': 'post',
                "ajax": "data/vessel_charter_search.php",
                "columns": [
                    // {
                    //     "className": 'dt-control',
                    //     "orderable": false,
            ...
            $('#delete_record_search').click(function() {
                ...
                if (deleteids_arr.length > 0) {
                    ...
                    if (confirmdelete == true) {
                        $.ajax({
                            url: 'ajax/delete/delete_vessel_search_log.php',
                            type: 'post',
                            data: {
                                request: 2,
            ...
            $('#after_search tbody').on('click', 'tr', function() {
                ...
                var vessel_c_id = id;
                console.log(vessel_c_id)

                var table1 = $('#search_data').DataTable({
                    "ajax": "data/get_vessel_charter_log_data.php?vessel_c_id=" +
                        vessel_c_id + "",
                    "columns": [
                ...
                function format_search(d) {
                    ...
                    return '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">' +
                        ...
                        '</div>' +
                        // '<div class=""><a href="messenger.php?id='+d.created_by+'" class="btn  text-light my-2 font-italic font-bold" style="letter-spacing:0;background-color: #00997d;"> Message Directly </a></div>' +
        ...
        $('#example tbody').on('click', 'tr', function() {
            ...
            var vessel_c_id = data['id'];
            console.log('vessel_c_id  ' + vessel_c_id);

            var table1 = $('#example1').DataTable({
                "ajax": "data/get_vessel_charter_log_data.php?vessel_c_id=" + vessel_c_id + "",
                "columns": [
    ...
    <script>
    function post_data(v_vessel_type, v_charter_type, v_region, v_country, v_ports, laycan_from, laycan_to,dwt_from,dwt_to) {
        ...
        var data_lead = "v_vessel_type=" + v_vessel_type +
            "&dwt_from=" + dwt_from +
            "&dwt_to=" + dwt_to +
            "&v_charter_type=" + v_charter_type +
    ...
    <?php
        if (isset($_POST["v_vessel_type"])) {
            ...
            $v_vessel_type = implode(",",$v_vessel_type);
            $v_charter_type = implode(",",$v_charter_type);
            ...
            echo "<script> post_data('".$v_vessel_type."', '".$v_charter_type."', '".$v_region."', '".$v_country."', '".$v_ports."', '".$laycan_from."', '".$laycan_to."', '".$dwt_from."', '".$dwt_to."');</script>"; 
