...
<body>
                        ...
                        <!-- <div class="row">
                            <div class="col-md-2 mb-3">
                                <a id="new_ser_req" class="btn text-light top_bt" data-toggle="modal" style="background-color: #00997d;"
                                    data-target="#zoomupModal"><i class="fas fa-search" aria-hidden="true"></i> Search
                                    Vessel for Charter</a>
                            </div>
                            <div class="col-md-2">
                                <a href="new_vessel.html" class="btn text-light top_bt" style="background-color: #00997d;">
                                    <i class="fas fa-plus" aria-hidden="true"></i> Add Vessel for Charter
                                </a>
                            </div>
                        </div> -->
                        <div class="row">
                            <div class="col-md-2 mb-3">
                                <button id="myBtn"  class="btn text-light top_bt" data-toggle="modal" style="background-color: #00997d;"
                                    data-target="#zoomupModal"><i
                            ...
                            <div class="col-md-2">
                                ...
                                <button id="add_ser_req" class="btn text-light top_bt  "
                                    onclick="location.href = 'new_vessel.php';"
                                ...
                                <div class="col-md-12">
                                    <div class="panel-container-vertical">
                                        ...
                                        <div class="splitter-horizontal" style="text-align: center;">
                                            <img src="images/expand-arrows.png" alt="" srcset="" style="position: relative;top: -12px;">
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-row mb-4">
                                            <label for="inputEmail4">Vessel Type</label>
                                            <div class="form-group col-md-12">


                                                <select class="form__select" name="transport">
                                                    <option data-display="Choose Vessel Type">Choose Vessel Type</option>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input class="form__field" type="number" name="name"
                                    ...
                                    <div class="col-md-4">
                                        <label for="inputEmail4">Charter Type</label>

                                        <select class="form__select" name="transport">
                                            <option data-display="Choose Charter Type">Choose Charter Type</option>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form__select" name="transport">
                                            <option data-display="Choose Region">Choose Region</option>
                                    ...
                                    <div class="col-md-4">
                                        <label for="inputEmail4">Ports <span style="color: transparent;">...</span></label>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            return '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">' +
                '<tr>' +
                '<td>Built Year: <br>12</td>' +
                '<td>IMO Number: <br>123</td>' +
                
                '<td>Speed Laden: <br>213Nm/H</td>' +
                '<td>LOA Max: <br>123 Meters</td>' +
                '<td>Fresh Water Draft:: <br>213 Meters</td>' +
                
                '<td>Container Capacity 20FT:<br>123 Gallons</td>' +
                '<td>IFO Consumption Empty:<br>123</td>' +
                '<td>MGO Consumption Empty:<br>123</td>' +
                '<td>Lane Meters:<br>123</td>' +
                '<td>Lane Meters:<br>123</td>' +
                '<td>Additional Info:<br>Test</td>' +
                '</tr>' +

                '<tr>' +
                    '<td>DWT: <br>12MT</td>' +
                '<td>Call Sign: <br>123</td>' +
                
                '<td>Gross Tonnage: <br>12312 MT</td>' +
                '<td>Beam Max: <br>123 Meters</td>' +
                '<td>Grain Capacity: <br>213 </td>' +
                
                '<td>Container Capacity 40FT:<br>123 Gallons</td>' +
                '<td>IFO Consumption Laden:<br>12312</td>' +
                '<td>MGO Consumption Laden:<br>123</td>' +
                '<td>P I Club:<br>123</td>' +
               
                '</tr>' +

                '<tr>' +
                    '<td>DWCC: <br>12MT</td>' +
                '<td>Speed Ballast: <br>123</td>' +
                
                '<td>Net Tonnage: <br>12312 MT</td>' +
                '<td>Summer Draft: <br>12312 Meters</td>' +
                '<td>Bale Capacity: <br>213 </td>' +
                
                '<td>Container Capacity 40CH:<br>233  Gallons</td>' +
                '<td>IFO Consumption Port:<br>12312</td>' +
                '<td>MGO Consumption Port:<br>123</td>' +
                '<td>Classed By:<br>123</td>' +
